          ...
          <div class="content-header bg-white-5">
            ...
            <a class="fw-semibold text-white tracking-wide" href="index.html">
              <span class="smini-visible">
                F<span class="opacity-75">C</span>
              </span>
              <span class="smini-hidden">
                Friend<span class="opacity-75">Cellular</span>
              </span>
            </a>
            <!-- END Logo -->
        ...
        <div class="content">
          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              <h3 class="block-title">@yield('subjudul')</h3>
            </div>
            <div class="block-content">
                @yield('content')
            </div>
        ...
        <div class="content py-0">
          <div class="row fs-sm">
            <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
              Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="https://pixelcave.com" target="_blank">Cut Nyak Putroe</a>
            </div>

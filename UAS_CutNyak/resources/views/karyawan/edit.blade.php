...
@section('content')
        <!-- Page Content -->
        <div class="content">
          <form class="js-validation" action="/karyawan/{{$kar->id}}" method="POST">
            @method('PUT')
            @csrf
                ...
                <div class="row items-push">
                  <div class="col-lg-8 col-xl-5">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" value="{{$kar->nm_kar}}" name="nm_kar" placeholder="masukkan nama Karyawan">
                    </div>
                    <div class="mb-4">
                      <label class="form-label" for="hp_kar">Nomor HP Karyawan <span class="text-danger">*</span></label>
                      <input type="text" class="form-control" value="{{$kar->hp_kar}}" name="hp_kar" placeholder="masukkan No.HP">
                    </div>
                  </div>
                </div>
                <!-- END Regular -->
